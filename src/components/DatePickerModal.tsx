      ...
      <div className="w-full max-w-sm bg-[#121212] border border-neutral-800 rounded-t-3xl sm:rounded-3xl p-5 shadow-2xl flex flex-col animate-in slide-in-from-bottom sm:zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between pb-3.5 border-b border-neutral-800 mb-3.5">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-[#1a1a1a] border border-neutral-800 text-neutral-200 flex items-center justify-center">
        ...
        <div className="flex items-center justify-between px-2 py-2.5 mb-2.5 bg-[#1a1a1a] border border-neutral-800 rounded-2xl">
          <button
            type="button"
            onClick={handlePrevMonth}
            className="w-9 h-9 rounded-xl bg-[#262626] hover:bg-[#333333] active:scale-90 text-neutral-200 hover:text-white flex items-center justify-center transition-all cursor-pointer border border-neutral-800"
                ...
                className={`aspect-square rounded-xl flex flex-col items-center justify-center text-xs sm:text-sm font-bold relative transition-all active:scale-90 cursor-pointer ${
                  isSelected
                    ...
                    ? isToday
                      ...
                      : 'text-neutral-100 hover:bg-[#262626]'
                    : 'text-neutral-400 hover:text-neutral-200 hover:bg-[#262626]/50'
                }`}
              >
                <span>{cell.day}</span>
                {isToday && !isSelected && (
                  <span className="w-1.5 h-1.5 rounded-full bg-white mt-0.5 absolute bottom-1.5" />
                )}
              </button>
            );
          })}
        ...
        <div className="mt-3.5 pt-3.5 border-t border-neutral-800 flex items-center justify-between">
          <button
            type="button"
            onClick={handleSelectToday}
            className="px-4 py-2 rounded-full bg-white hover:bg-neutral-200 text-black text-xs sm:text-sm font-bold transition-all active:scale-95 cursor-pointer shadow-sm"
          >
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-full bg-[#1a1a1a] hover:bg-[#262626] border border-neutral-800 text-xs sm:text-sm font-bold text-neutral-200 hover:text-white transition-all active:scale-95 cursor-pointer"
          >
            Đóng
          </button>
        </div>
