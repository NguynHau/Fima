...
export const MonthCalendar: React.FC<MonthCalendarProps> = ({
  ...
  return (
    <div className="space-y-2 pb-16">
      {/* Month Selector Bar */}
      <div className="flex items-center justify-between bg-[#121212] rounded-xl p-1.5 px-2 border border-[#262626] shadow-sm">
        <button
          onClick={onPrevMonth}
          className="w-7 h-7 rounded-lg hover:bg-[#1a1a1a] text-neutral-300 flex items-center justify-center transition-colors active:scale-95 cursor-pointer"
        ...
        <div className="flex items-center gap-1.5">
          ...
          {!isCurrentRealMonth && (
            <button
              ...
              className="text-[10px] font-bold text-neutral-200 bg-white/10 hover:bg-white/20 border border-white/15 px-2 py-0.5 rounded-md transition-colors cursor-pointer"
            >
              Hôm nay
            </button>
          )}
      ...
      <div className="bg-[#121212] p-1 rounded-xl border border-[#262626] grid grid-cols-3 gap-1 shadow-sm">
        <button
          type="button"
      ...
      {/* Month Summary Cards */}
      <div className="bg-[#121212] rounded-xl p-2 px-2.5 border border-[#262626] shadow-sm">
        <div className="grid grid-cols-3 gap-1 divide-x divide-[#262626]">
          {/* Income */}
          <div className="pr-1 text-center">
            <div className="text-[9px] font-medium text-neutral-400 flex items-center justify-center gap-0.5 uppercase tracking-wider">
          ...
          <div className="pl-1 text-center">
            <div className="text-[9px] font-medium text-neutral-400 flex items-center justify-center gap-0.5 uppercase tracking-wider">
              <Scale size={10} className="text-neutral-400" />
              <span>Lệch</span>
            </div>
            <div
      ...
      {/* Calendar Grid */}
      <div className="bg-[#121212] rounded-2xl p-2 sm:p-2.5 border border-[#262626] shadow-sm">
        {/* Day of week headers */}
          ...
          {calendarCells.map((cell) => {
            ...
            return (
              <button
                ...
                className={`min-h-[46px] sm:min-h-[50px] p-1 rounded-xl flex flex-col justify-between items-center transition-all relative border active:scale-95 cursor-pointer ${
                  cell.isToday
                    ? 'border-neutral-400 bg-neutral-800/80 font-bold shadow-xs'
                    : cell.isCurrentMonth
              ...
              >
                ...
                <div className="w-full mt-auto text-center">
                  {hasActivity ? (
                    <div
                      className={`text-[8px] sm:text-[9px] font-bold tracking-tight px-0.5 py-0 rounded leading-tight truncate font-mono ${
                        cell.net > 0
